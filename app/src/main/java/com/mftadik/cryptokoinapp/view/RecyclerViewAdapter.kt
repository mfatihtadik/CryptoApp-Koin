...
import com.mftadik.cryptokoinapp.databinding.RecyclerRowBinding
import com.mftadik.cryptokoinapp.model.Crypto

class RecyclerViewAdapter(private val cryptoList : ArrayList<Crypto>, private val listener : Listener) : RecyclerView.Adapter<RecyclerViewAdapter.RowHolder>() {
